...
pub const fn help() -> &'static str {
    concat!(
        ...
        "      --graphql-variables <json> Set GraphQL variables as a JSON object\n",
        "      --graphql-operation-name <name> Set a GraphQL operation name\n",
...
const REQUEST_HELP: &str = concat!(
    ...
    "  set <path> <selector> [--name <name>] [--method <method>] [--url <url>] [--graphql-query <text> [--graphql-variables <json>] [--graphql-operation-name <name>]]\n",
