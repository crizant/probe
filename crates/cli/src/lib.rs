...
const REQUEST_HELP: &str = concat!(
    ...
    "  set <path> <selector> [--name <name>] [--method <method>] [--url <url>] [--graphql-query <text>] [--graphql-variables <json>] [--graphql-operation-name <name>] [--graphql-extensions <json>]\n",
    "  create <path> --name <name> [--parent <folder>] [--index <index>] [--method <method>] [--url <url>] [--type http|graphql] [--graphql-query <text>] [--graphql-variables <json>] [--graphql-operation-name <name>] [--graphql-extensions <json>]\n",
