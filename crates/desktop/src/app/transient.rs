...
pub(super) struct TransientSurfaces {
    ...
    pub(super) recent_collection_focus_handles: RefCell<BTreeMap<PathBuf, FocusHandle>>,
...
impl TransientSurfaces {
    pub(super) fn new(cx: &mut Context<ProbeApp>) -> Self {
        Self {
            ...
            recent_collection_focus_handles: RefCell::new(BTreeMap::new()),
            structure_add_menu_open: false,
            request_execution_menu_open: false,
            request_tab_add_menu_open: false,
